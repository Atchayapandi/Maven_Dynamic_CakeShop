	...
	<form action="Register" method="post">
		<div class="container">
			...
			<div class="card">
				...
				<br> <input type="email" name="EmailId" placeholder="Email_id"
					required><br>
				...
				<br> <input type="text" name="address" placeholder="address"
					pattern="[A-Za-z0-9]{4,}+[,][A-Za-z]{4,}+[,][0-9]{6}+{25,}"
					required><br>
				<br>
				<button class="button button1" type="submit" id="button">Submit</button>
				<br>
				<button class="button button1" type="reset" id="button">Reset</button>
	</form>
